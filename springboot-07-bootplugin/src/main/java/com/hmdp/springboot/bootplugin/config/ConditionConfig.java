package com.hmdp.springboot.bootplugin.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.pool.DruidDataSourceMBean;
import com.hmdp.springboot.bootplugin.pojo.Cat;
import com.hmdp.springboot.bootplugin.pojo.Dog;
...
public class ConditionConfig {
    ...
    @ConditionalOnMissingClass("com.hmdp.springboot.bootplugin.pojo.User")
    @Bean
